...
int main(void)
{
  ...
  in_coin = Fram_Read(502);
  total_income = Fram_Read(503);
  noc_num = Fram_Read(504);
...
void EXTI9_5_IRQHandler(void)		
{
  ...
  else if(EXTI->PR & 0x0200)//9 50coin 		
  {
    EXTI->PR |= 0x0200; 		
    in_coin +=50;
    LCD_SetBrushColor(RGB_YELLOW);
